...
c.LDAPAuthenticator.server_address = 'ldap://ldap-server'

c.LDAPAuthenticator.bind_dn_template = [
    'cn={username},ou=users,dc=pl,dc=eso,dc=org',
]
...
c.JupyterHub.hub_ip = 'jupyterhub-app'
...
c.SwarmSpawner2.image = '$DLAB_DOMAIN_SHORT$:5000/jupyterhub_singleuser_app'

c.SwarmSpawner2.notebook_dir = '/home/jovyan'
c.SwarmSpawner2.volumes = {
    '$DLAB_HOME$/appmode_temp': '/home/jovyan',
    '/opt/anaconda3': {'bind': '/opt/anaconda3', 'mode': 'ro'},
    '$DLAB_HOME$/toolscfg/jupyter_appmode/single/start-singleuser.sh': {'bind': '/usr/local/bin/start-singleuser.sh', 'mode': 'ro'},
}
c.SwarmSpawner2.remove_containers = True

c.SwarmSpawner2.prefix = 'jupyter-app'
...
c.Authenticator.admin_users = set('$DLAB_USER$')
