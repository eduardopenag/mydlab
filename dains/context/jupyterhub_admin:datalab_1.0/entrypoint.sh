...
cp -a /tmp/.ssh/* /home/dlabmgr/.ssh; rm /toolscfg/cronicle/logs/cronicled.pid; node "$LIB_DIR/main.js" & jupyterhub -f /srv/jupyterhub/jupyterhub_config.py & cd /datalake; voila --no-browser
