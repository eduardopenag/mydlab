...
## Add environments:
# vlt
/opt/anaconda3/bin/python -m ipykernel install --name VLT-standard --user

/opt/conda/bin/pip install appmode
/opt/conda/bin/jupyter nbextension enable --py appmode
/opt/conda/bin/jupyter serverextension enable --py  appmode
