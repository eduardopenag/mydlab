...
c.SwarmSpawner2.image = '$DLAB_DOMAIN_SHORT$:5000/jupyterhub_singleuser_vlt'

c.SwarmSpawner2.notebook_dir = '/home/jovyan'
c.SwarmSpawner2.volumes = {
    '$DLAB_HOME$/home/{username}': '/home/jovyan',
    '$DLAB_HOME$/datalake/usershared': '/share',
    '$DLAB_HOME$/datalake': {'bind': '/datalake', 'mode': 'ro'},
}
